...
Before creating the Canvas, we set up the [Braze Audience Sync to Google](https://www.braze.com/docs/partners/canvas_audience_sync/google_audience_sync/) integration so that we can add user data from Braze to Google Audiences to send advertisements based on behavioral triggers, segmentation, and more.
...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/lapsed_user_old_name_description.png?d961194c3088adb3eae325346cfc3896){: style="max-width:45%;"}
...
!["Set Up Canvas Details" step with Canvas name of "Lapsed User - Visit App" and a brief Canvas description](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_1.png?84e2bb623012487dd567a5fa24be12d2)
...
!["Assign Conversion Events" section with a primary conversion even of a user starting a session in a specific app.](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_2.png?0658bc2eb73128b221fda0733017c27f)
...
!["Entry Schedule" step for a scheduled Canvas that enters users at a designated time.](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_3.png?8b9eb3fa03b460d0a72cd0b52491f30b)
...
!["Target Audience" step targeting users who last used the apps in 30 days.](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_4.png?737771dd16574df9a9b8b81e3430d5ad)
...
!["Quiet Hours" section with a start time of 12 am and end time of 8 am.](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_5.png?0ad2c1d24d74e13f09d7a823bfcab880)
...
![Canvas Message step for an email that tells users to unlock new perks when they visit today.](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_6.png?fa6e55e20f556e81804ae4eb00b63bc9)

{: start="2"}
2. Customize the action path component called “Start Session?” by selecting our app for the **Started Session** path. 

![Action path for sessions that are started in a specific app.](https://www.braze.com/docs/assets/img/canvas_templates/lapsing_user_7.png?a021a1c812a3f8e81b5a923a14f16032)
...
6. Keep the default for the [Experiment Path](https://www.braze.com/docs/user_guide/messaging/canvas/canvas_components/experiment_step#experiment-paths) component called “A/B Test”. This will randomly send one of two promotions (that we will customize in the next step) to users who’ve had fewer than two sessions.
