...
- A [catalog](https://www.braze.com/docs/user_guide/data/activation/catalogs/create/) containing information about your item
- [Back-in-stock notifications](https://www.braze.com/docs/user_guide/data/activation/catalogs/catalog_triggers/back_in_stock_notifications/#how-back-in-stock-notifications-work) must be set up for the item you want to message users about
...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_old_name_description.png?53cca5035f415a42cac03e92ca31bf58){: style="max-width:45%;"}
...
!["Set Up Canvas Details" step with a Canvas name of "Back in Stock - Classic Straight Leg" and a brief Canvas description.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_1.png?d5f2581471073bdba9c963219b391435)
...
!["Assign Conversion Events" section for the conversion event type of purchasing the Classic Straight Leg product with a conversion deadline of 7 days.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_2.png?31a8d0464bfbd817329d4ae223d9264c)
...
!["Entry Schedule" step for an action-based Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_3.png?3787580898ccc6545ed8fcff3839426f)

{: start="2"}
2. Set the **Start Time (Required)** to our desired start date and time.

!["Entry Window" section with a start time of January 2, 2025 at 12 am.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_4.png?4945b58e1e653da4500c5d10a4db22ed)
...
!["Target Audience" step with the segment of "Favorited - Classic Straight Leg Jeans".](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_5.png?7007f369ef210f73b54b7c3614e0fd9b)
...
!["Entry Controls" section with a checkbox for allowing users to re-enter this Canvas with a maximum duration of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_6.png?3d66dc7b1d15b336feaf07ba65591b4a)

{: start="4"}
4. Adjust the exit criteria to remove users who performed the custom event of unfavoriting the Classic Straight Leg jeans.

!["Exit Criteria" section with a exception for users that perform the custom event of "Unfavorited".](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_7.png?e7011b273b0b50bef8ee1cef32a3e1c0)
...
!["Send Settings" step targeting users who are subscribed or opted in.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_8.png?502bfec48d992322c763a483a4da47b1)

### Step 6: Customize your Canvas

Now, we’ll build our Canvas by customizing the channels and content that will send to users. Because we’re using all four of the template channels (mobile and web push, SMS, and email) and using the [Intelligent Channel](https://www.braze.com/docs/user_guide/brazeai/intelligence_suite/intelligent_channel/) filter, we don’t need to add or remove any.

**Tip:**


You can use [Canvas entry properties](https://www.braze.com/docs/user_guide/messaging/canvas/create_a_canvas/context_and_event_properties/) to customize the messages in your Canvas based on which product you're referring to.
...
![Mobile Push Canvas step with a message notifying users that a product is back in stock.](https://www.braze.com/docs/assets/img/canvas_templates/back_in_stock_9.png?fe5cfe97715ef9ca2d3abf99820d9a73)
