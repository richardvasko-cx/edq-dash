...
![API Usage Dashboard with 130 total requests, with a 70 percent success rate and 30 percent failure rate.](https://www.braze.com/docs/assets/img/api_usage_dashboard/api_usage_dashboard.png?ba1c13502ad8c721758738f7cb161187)
...
![Filters to apply to the dashboard, including: API key, endpoint, response codes, group data, and date.](https://www.braze.com/docs/assets/img/api_usage_dashboard/filters.png?0bc1c8fba532c72b330e2dd4ff5b4264){: style="float:right;max-width:35%;margin-left:15px;"}
