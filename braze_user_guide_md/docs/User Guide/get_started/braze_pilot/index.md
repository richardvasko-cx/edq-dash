...
Steppington is a fitness app with workouts, exercise goals, and a Steppington+ premium service. It offers several places to demonstrate [Content Cards](https://www.braze.com/docs/user_guide/channels/content_cards/), a section that can be revealed with [feature flags](https://www.braze.com/docs/developer_guide/feature_flags), and a robust library of custom event logging that make it possible to illustrate many customer journeys for this industry.

![The home page for Steppington with icons for marathon training, yoga, cycling, and weights.](https://www.braze.com/docs/assets/img/braze_pilot/steppington_app.png?c4d0c49ad97fd5f1d150a259f3ee93dd){:style="max-width:50%"}
...
![A product page for PantsLabyrinth with options to add jeans to cart.](https://www.braze.com/docs/assets/img/braze_pilot/pantslabyrinth_app.png?25551e346a1719cf53d1ee2e7f77498d){:style="max-width:50%"}
...
![The MovieCanon app with different thrillers to watch.](https://www.braze.com/docs/assets/img/braze_pilot/moviecanon_app.png?391e26d7110a668529f84f34948d8aca){:style="max-width:50%"}
...
![The first step of setting up Pilot.](https://www.braze.com/docs/assets/img/braze_pilot/setup_wizard.png?d15ddb704dbc928873a3a997abe7f284){:style="max-width:40%"}
...
For more on the Braze SDK, check out [Integration](https://www.braze.com/docs/user_guide/get_started/integrations/).

![The Braze customer engagement stack, which includes integrations, APIs, SDKs for data ingestion, classification, orchestration, personalization, and action with messaging channels for an interactive feedback loop with your customers.](https://www.braze.com/docs/assets/img/braze_pilot/braze_sdk_diagram.png?cae7f4101c2612eb036da9d397cf7d97){:style="max-width:70%"}
...
This connection status represents the experience of a guest of your app or website who hasn’t logged in yet. If you initialize Pilot as an anonymous user, Braze creates an [anonymous user profile](https://www.braze.com/docs/user_guide/data/unification/user_data/user_profile_lifecycle/anonymous_users/) for you and logs data about your activity there. Anonymous users can still be targeted with campaigns, but you won’t be able to look up their user profile directly in your Braze dashboard.
...
Braze Pilot currently supports [in-app messages](https://www.braze.com/docs/in-app_messages/), which appear in your app, delivering timely messaging while the user is actively engaging.

![An in-app message in the MovieCanon app "Enjoying MovieCanon? Refer your friends!" with an option to enter your email address to send a referral.](https://www.braze.com/docs/assets/img/braze_pilot/moviecanon_iam.png?9c3fd76cf26434ec84e11a069cff919f){:style="max-width:40%"}