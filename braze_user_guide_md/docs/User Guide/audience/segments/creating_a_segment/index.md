# [![Braze Learning course](https://www.braze.com/docs/assets/img/bl_icon3.png?5f6465f63e399dec15d7020b6f4d2452)](https://learning.braze.com/segmentation-course){: style="float:right;width:120px;border:0;" class="noimgborder"}Create a segment
...
- Add a [team](https://www.braze.com/docs/user_guide/administer/global/user_management/teams/) to your segment.
- Add [tags](https://www.braze.com/docs/user_guide/administer/global/workspace_settings/tags/) to your segment for further organization.

![Create Segment modal where the segment is named "Lapsed Users" with the Segment Description as "This is our main Lapsed User segment to target non-actives within the past fourteen days." with two buttons: Cancel and Create Segment.](https://www.braze.com/docs/assets/img_archive/segment_app_selection.png?64546f15e5f12bcf6a82cd28839d67fa){: style="max-width:80%;"}
...
![Segment Details panel with the "Users from all apps" option selected in the Apps Used section.](https://www.braze.com/docs/assets/img_archive/Segment2.png?5c460b526edc194f290744aed93bbe92){: style="max-width:80%;"}
...
![Filter group with an editing icon next to its name.](https://www.braze.com/docs/assets/img_archive/edit_filter_group_name.png?4b2c6bb5f4f67b2a5eebd7b1617b36e8)
...
![Filter group for users in segment "foodies" and not in segments "non-foodies" or "candy-lovers".](https://www.braze.com/docs/assets/img_archive/or_operator_segment.png?d6bff360c3bbf4c39df24cbb9af78770)
...
Depending on the specific filter you select, you will have different operators for identifying filter values. To dive deeper into the operators available for different types of custom attributes, see [Custom attribute storage](https://www.braze.com/docs/user_guide/data/activation/attributes/custom_attributes#setting-custom-attributes). Note that when using the “is any of” operator, the maximum number of items you can include in that field is 256.
...
![Segmenter filter groups with the AND operator.](https://www.braze.com/docs/assets/img_archive/segmenter_filter_groups.png?ba850355b8967497aaab8f2748046d98)
...
![An exclusion group with two filters.](https://www.braze.com/docs/assets/img_archive/segmenter_exclusion_groups.png?8702c905449c98e955c0f46fd387ff49)
...
![Two filters with segment funnel statistics.](https://www.braze.com/docs/assets/img_archive/segment_funnel_statistics.png?e1fc04089930c04a53f64a85f687a0fb)
...
![User Lookup section with a search field.](https://www.braze.com/docs/assets/img_archive/user_lookup.png?a23b1b90dd9a139a54218f61761a0040){: style="max-width:70%;"}
...
![A user lookup of "testuser" triggers an alert stating, "testuser matches all of the segments, filters, and apps.](https://www.braze.com/docs/assets/img_archive/user_lookup_match.png?b28fa566457c75a7bee6a38d72e927e6)
...
![A user lookup with an alert stating, "test1 does not match the following targeting criteria:" and displays missing criteria.](https://www.braze.com/docs/assets/img_archive/user_lookup_nomatch.png?c3f9d41481597bc04170f5ebb58fab56)
...
To learn about monitoring your segment’s membership and size, refer to [Measuring segment size](https://www.braze.com/docs/user_guide/audience/segments/measuring_segment_size/).
...
Users have more than one device if they log into the same account on multiple devices. You can check for multiple devices in the **Recent Devices** section of a [user profile](https://www.braze.com/docs/user_guide/audience/manage_audience/user_profiles/).
...
You can specify that only one push notification is sent to each user. When [composing your message](https://www.braze.com/docs/user_guide/channels/push/create_a_push_message#step-4-compose-your-push-message), select **Only send to the user’s last used device** under **Additional Settings**.

!["Additional settings" with a checkbox for only sending to the user's last used device.](https://www.braze.com/docs/assets/img_archive/send_to_last_device.png?d6e74efc2f8219e0047fb8ff2eda04e8){: style="max-width:60%;"}
