...
![Button to create a promotion code.](https://www.braze.com/docs/assets/img/promocodes/promocode1.png?9c13b2e2b004c7be2c061ac1fcabec19)
...
![A promotion code list named "SpringSale2025" with the code snippet "spring25".](https://www.braze.com/docs/assets/img/promocodes/promocode3.png?ec8bf427f238e77ccf70f909adafd5f3){: style="max-width:80%"}
...
![List expiration settings that all remaining codes will expire on April 30, 2025 at 12 am.](https://www.braze.com/docs/assets/img/promocodes/promocode4.png?8af401d368d9e9aac921c2f718c789a0){: style="max-width:80%"}
...
![CSV file named "springsale" that was successfully uploaded.](https://www.braze.com/docs/assets/img/promocodes/promocode7.png?5ee1911bd2eda3ff2d4fbe743ca4014d)

{:start="2"}
2. After selecting save, a new row appears in the **Import History**. 
...
![Promotion codes in the process of being uploaded.](https://www.braze.com/docs/assets/img/promocodes/promocode8.png?289a3860f6459c0754ae0aa2ba0b9888)
