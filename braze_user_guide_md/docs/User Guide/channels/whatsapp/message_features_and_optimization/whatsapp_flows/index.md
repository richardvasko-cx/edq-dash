...
![WhatsApp message composer using a WhatsApp Flow template.](https://www.braze.com/docs/assets/img/whatsapp/flows/composer_flow_template.png?914fdae75470beca5a0919f7947a2ea8){: style="max-width:80%;"}
...
![A message step for a WhatsApp response message type and Flow message layout.](https://www.braze.com/docs/assets/img/whatsapp/flows/message_step_flow_message.png?a97e8908a174d6ff2e420c092a7ab537){: style="max-width:80%;"}

{: start="2"}
2. Select the respective Flow, then continue creating your message. 

![A Flow message response composer with an extended dropdown for selecting a Flow.](https://www.braze.com/docs/assets/img/whatsapp/flows/flow_message_composer.png?a936f38b921af1a7a57008236becaec5){: style="max-width:80%;"}
...
![Preview window displaying a form for a user to finish sign up.](https://www.braze.com/docs/assets/img/whatsapp/flows/flow_preview.png?058a7f1bb8121a852da0b5dafa209996){: style="max-width:50%;"}
...
![Meta Flow section with an option to view the Flow custom attribute.](https://www.braze.com/docs/assets/img/whatsapp/flows/flow_custom_attribute.png?9244b2e8845aa3c93d01ef307260f20c){: style="max-width:70%;"}
...
![Meta Flow section with a checkbox to save Flow responses as a custom attribute.](https://www.braze.com/docs/assets/img/whatsapp/flows/save_flow_responses_checkbox.png?5b4ad9a17ae7115fe9b5b509427bfe87){: style="max-width:80%;"}
...
![User Update step with an advanced JSON editor.](https://www.braze.com/docs/assets/img/whatsapp/flows/user_update_advanced_json_editor.png?f766f1e0f97663cd77b1497fe814c634)
...
2. In the UI editor, use the Liquid ```{{whats_app.${inbound_flow_response}}}``` to populate the custom attribute and save the entire user’s Flow response to it. You need to populate the key value as ```{{whats_app.${inbound_flow_response}}}``` before selecting the custom attribute you created.

![User Update step that uses the UI editor.](https://www.braze.com/docs/assets/img/whatsapp/flows/user_update_ui_editor.png?5658fbd3eb39084404f553631366bbe7)
...
![A window displaying the contents of a "flow_1" custom attribute.](https://www.braze.com/docs/assets/img/whatsapp/flows/user_attribute_flow.png?454a40c834bdccd521268726fa07483f)
...
![Flow custom attributes details window with schema dropdown.](https://www.braze.com/docs/assets/img/whatsapp/flows/flow_custom_attribute_details.png?b32a6ec499b763aa82cbf2101b59175f){: style="max-width:80%;"}
...
![User Update step with a Nested Custom Attributes personalization.](https://www.braze.com/docs/assets/img/whatsapp/flows/nested_custom_attributes.png?f75ccacaf3c18404695aa05b4887ce00)

{: start="3" }
3. Select the key attribute you’d like to save and insert the Liquid into the **Key Value** field.

![Window for "flow_1" with attributes to select from.](https://www.braze.com/docs/assets/img/whatsapp/flows/attribute_key.png?eb19f489a354f09ffea841f96d6fddcb)
...
![WhatsApp message composer with an "Add Personalization" component to insert a WhatsApp properties personalization with the custom attribute `inbound_flow_response`.](https://www.braze.com/docs/assets/img/whatsapp/flows/parsed_json.png?b35cbe25eda53442363c2889518da6d6)
