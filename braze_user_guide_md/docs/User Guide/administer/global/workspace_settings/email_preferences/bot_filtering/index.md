...
Unsubscribes from suspected bot clicks will not be affected. Braze will continue to process all unsubscribe requests as usual. If you would like Braze to block these unsubscribes, submit [product feedback](https://www.braze.com/docs/user_guide/administer/personal/product_portal).
...
- [Clicked Alias in Campaign](https://www.braze.com/docs/user_guide/audience/segments/segmentation_filters#clicked-alias-in-campaign)
- [Clicked Alias in Canvas Step](https://www.braze.com/docs/user_guide/audience/segments/segmentation_filters#clicked-alias-in-canvas-step)
- [Clicked Alias in Any Campaign or Canvas Step](https://www.braze.com/docs/user_guide/audience/segments/segmentation_filters#clicked-alias-in-any-campaign-or-canvas-step)
- [Last Engaged with Message](https://www.braze.com/docs/user_guide/audience/segments/segmentation_filters#last-engaged-with-message)
- [Intelligent Channel](https://www.braze.com/docs/user_guide/audience/segments/segmentation_filters#intelligent-channel)
...
![Bot filtering email setting turned on in Email Preferences.](https://www.braze.com/docs/assets/img/bot_tracking_email.png?783acd6912ff44dae47fdeb8ceab914e)
