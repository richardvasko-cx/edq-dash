...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/email_signup1.png?4ad2072b52b8e93665fe1b434c8fc1e9){: style="max-width:50%;"}
...
![The new name, description, and tag for the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/email_signup2.png?d42dba10d737ce8e4af1859d2153776f){: style="max-width:90%;"}
...
!["Assign Conversion Events" section for the conversion event type of opting in for email.](https://www.braze.com/docs/assets/img/canvas_templates/email_signup3.png?7d8330f1402fe4b4d225d3c6086ff86a){: style="max-width:90%;"}
...
![An action-based entry schedule to enter users who start any session into the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/email_signup4.png?e6bd2f077758ec7849c5acfc72a5b316){: style="max-width:90%;"}

For the **Entry Window**, update the **Started Time (Required)** to our desired date and time.

![An entry window with the start time January 16, 2025 at 12:30 pm. Users will enter this message in their local time zone.](https://www.braze.com/docs/assets/img/canvas_templates/email_signup5.png?704d83a875ff059843f0e0d8afc689dd){: style="max-width:90%;"}
...
![Default sending options to only send to users who are subscribed or opted-in.](https://www.braze.com/docs/assets/img/canvas_templates/email_signup7.png?f979aa2a38c835582d54a17e2f3a5a3e){: style="max-width:90%;"}
