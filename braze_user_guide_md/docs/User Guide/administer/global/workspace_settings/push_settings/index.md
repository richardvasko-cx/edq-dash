...
These settings apply globally to all push campaigns unless a different TTL is set for a specific message. To adjust a message's TTL, see [Advanced campaign settings](https://www.braze.com/docs/user_guide/channels/push/platform_specific_resources/android/advanced_campaign_settings#ttl).
...
![Push TTL settings for Firebase, Web, Kindle, and Huawei devices.](https://www.braze.com/docs/assets/img/push_ttl.png?7c6ba084a818644f24e561871edf4b2f)
...
![Android delivery priority settings.](https://www.braze.com/docs/assets/img/push_fcm_priority_settings.png?0face621a1309b45d94e122d11ca7ef8)
...
For more detailed information about FCM priority levels and deprioritization, see [Advanced campaign settings](https://www.braze.com/docs/user_guide/channels/push/platform_specific_resources/android/advanced_campaign_settings#fcm-priority).
