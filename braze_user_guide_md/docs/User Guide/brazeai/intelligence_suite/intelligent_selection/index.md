...
- The re-eligibility window is set to 24 hours or longer. Shorter windows aren't supported, as they would affect the integrity of the control variant. To learn more, refer to [this FAQ](https://www.braze.com/docs/user_guide/brazeai/intelligence_suite/intelligent_selection#why-is-re-eligibility-in-less-than-24-hours-not-available-when-combined-with-intelligent-selection).
...
![A/B Testing section of a campaign with Intelligent Selection enabled.](https://www.braze.com/docs/assets/img/intelligent_selection1.png?49ee08a4d9ec7b3c5f3e02cfca12d198)
...
![A Canvas with two variants, each set to 50% variant distribution, allowing Intelligent Selection to be enabled.](https://www.braze.com/docs/assets/img/intelligent_selection.png?e7aa9f750ae7e1bf49cbd0af08dc0d7b)

This allows you to edit the variant distribution and turn on Intelligent Selection. 

![Intelligent Selection option turned on for a Canvas](https://www.braze.com/docs/assets/img_archive/canvas_intelligent_selection.png?63e19aa453f66a2734a0eda5909c1f69)
