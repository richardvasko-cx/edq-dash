...
We accept the following file types for fonts: `.ttf`, `.woff`, `.otf`, and `.woff2`. For more information, see [Asset files](https://www.braze.com/docs/user_guide/channels/in_app_messages/message_types/custom_html#asset-files).
...
![A GIF showing a promotional in-app message being created.](https://www.braze.com/docs/assets/img_archive/dnd_iam_create.gif?03e9d50280a35a2c846f860be2b58bc1)
...
![Options to customize the close x button in in-app messages including button size, fill color, background color, border style, and border radius.](https://www.braze.com/docs/assets/img_archive/close_x_button.png?0ce19392c5e4f08d524bc26ba208e132){: style="max-width:40%"}
...
![Option shown when highlighting text in an in-app message. A small paintbrush icon shows that you can wrap with span for style.](https://www.braze.com/docs/assets/img_archive/span_1.png?53b9b6bd077c386e9d9aa1eefafcc546){: style="max-width:40%"}

![Side panel for "Span Properties" that allows the end user to customize font family, font weight, font size, letter spacing, and text color.](https://www.braze.com/docs/assets/img_archive/span_2.png?ba63ee650302a3aefcf6820a976ce4e8){: style="max-width:40%"}

### Rows

Rows are structural units that define the horizontal composition of a section of the message by using cells.

![Rows you can add in your in-app message.](https://www.braze.com/docs/assets/img_archive/dnd_iam_rows.png?ded2a042d9f0fdf6e9701dea979b8e7c){: style="max-width:40%"}
...
![Adjusting columns from the "Column customization" section.](https://www.braze.com/docs/assets/img_archive/dnd_iam_column_customization.gif?795ee5efa805771266ae36e3fdb1f84b){: style="max-width:40%"}
...
When a text block is selected in your in-app message, click <i class="fa-solid fa-wand-magic-sparkles" title="AI copywriter"></i> in the block toolbar to launch the [AI-powered copywriting assistant](https://www.braze.com/docs/user_guide/brazeai/generative_ai/copywriting/). The AI copywriting assistant passes a brief product name or description to OpenAI’s GPT3 copy generation tool to generate human-like marketing copy for your messaging.
...
![Orange dot that resets a text size to its default size.](https://www.braze.com/docs/assets/img_archive/dnd_iam_reset_styles.gif?ee2919a9188a511b771721a7431918ef){: style="max-width:45%"}
...
![Dropdown menu with option to copy styles.](https://www.braze.com/docs/assets/img_archive/dnd_iam_copypaste_styles.png?239f1c3b4aefa41ab9537749db93b7cd){: style="float:right;margin-left:15px;max-width:35%"}
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Keyboard shortcuts" }
