...
- A [survey](https://www.braze.com/docs/user_guide/channels/in_app_messages/message_types/simple_survey/) containing multiple questions to determine user preferences.

## Tailoring the template to your needs

Let’s say we’re working for StyleRyde, an on-demand ridesharing app that gets people where they need to go. Before creating the Canvas, we [set up a simple survey](https://www.braze.com/docs/user_guide/data/activation/catalogs/create/) that includes a series of engaging questions to determine the experience and impression of a user's first ride with the app.
...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey1.png?73aa579c3583778e1204632e271b5d0a){: style="max-width:50%;"}
...
![The new name, description, and tag for the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey2.png?0af24ea740be9cc76120d8fdbed647ae){: style="max-width:90%;"}
...
![Last Used App as the selected custom event name for the conversion event.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey3.png?6759ff87a3b97b6e1611c1745c55956e){: style="max-width:90%;"}
...
!["Entry Window" section with the start time January 30, 2025 at 12 pm.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey4.png?34451caf06a0ad5a446b4fb7522eb11a){: style="max-width:90%;"}
...
![The "First used these apps less than 1 days ago" filter selected to target the entry audience.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey5.png?92bcfbe62f52ad5add65a574dbcfeeb5){: style="max-width:90%;"}
...
!["Send Settings" section with the subscription settings for users who are subscribed or opted-in with Quiet Hours turned on between 12 am and 8 pm.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey6.png?52bf6c67078558118f40645848e04f98){: style="max-width:90%;"}
...
![A preview of the preferences survey that prompts users to select all interests that apply.](https://www.braze.com/docs/assets/img/canvas_templates/preference_survey7.png?17a1f4ba9b2c5d41b7877e1faff35738){: style="max-width:90%;"}
