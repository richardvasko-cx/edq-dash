...
3. If the global catalog settings have not been configured, you'll be prompted to set up the custom events and properties that will be used to trigger notifications. <br><br> ![Catalog settings drawer.](https://www.braze.com/docs/assets/img/catalog_settings_drawer.png?8775488f564715e97298bf8f2b6d2ab1){: style="max-width:70%;"}
...
![Catalog settings that show the price drop feature turned on. The price drop rule is a change of three percent to the original price.](https://www.braze.com/docs/assets/img/price_drop_notifications.png?964ef7262e8de87152d863cc0b289f35)
