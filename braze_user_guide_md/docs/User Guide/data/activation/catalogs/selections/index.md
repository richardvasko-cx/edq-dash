...
![Filter settings for catalog selection where the attribute is set to a Liquid custom attribute.](https://www.braze.com/docs/assets/img_archive/catalog_selections7.png?485d97e94c8a6e221b361bd61c293053)
...
![A Content Card with the header "You will LOVE these highly rated meals!" with the selection "recommendations_be_recent_category" in message composition section.](https://www.braze.com/docs/assets/img_archive/catalog_selections3.png?aad89ad6ee232502775e4c023d7e17e1){: style="max-width:90%;"}
...
![A Content Card with an image of char-grilled lemon chicken, and a list of three meal recommendations that include chicken based on the user's most recently viewed category.](https://www.braze.com/docs/assets/img_archive/catalog_selections4.png?8d2675c43d2f125d45dac0bad2c90118){: style="max-width:90%;"}
...
![A Content Card with an image of beef stroganoff, and a list of two meal recommendations that include beef based on the user's most recently viewed category.](https://www.braze.com/docs/assets/img_archive/catalog_selections5.png?e45ea82e89e28684b597f491840bf7ed){: style="max-width:90%;"}
