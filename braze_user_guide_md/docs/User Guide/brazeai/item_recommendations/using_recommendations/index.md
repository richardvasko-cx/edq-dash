...
!["Add Personalization" modal with item recommendation as the personalization type.](https://www.braze.com/docs/assets/img/add_personalization.png?a37ce7e045f981b352d45aa62faf7ca8){: style="max-width:30%;float:right;margin-left:15px;"}
...
![Image properties panel in the drag-and-drop editor](https://www.braze.com/docs/assets/img/image_with_liquid.png?55b77f7602c270024a9e16a94891370c){: style="max-width:45%"}
