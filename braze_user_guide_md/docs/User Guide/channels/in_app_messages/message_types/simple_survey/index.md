...
![Three simple survey messages: notification preferences, dietary preferences, and a customer satisfaction survey. The selected options in the surveys correspond to custom attributes that will be logged for that user.](https://www.braze.com/docs/assets/img/iam/iam-survey.png?53853a9d337cdc32d17e7ae2c573e2e1)

## SDK requirements {#supported-sdk-versions}

This in-app message will only be delivered to devices that support [Flex CSS](https://caniuse.com/flexbox), and must have at least the following [SDK versions](https://www.braze.com/docs/user_guide/messaging/campaigns/ideas_and_strategies/new_features#filtering-by-most-recent-app-versions). 

<div id='sdk-versions'><a href='/docs/developer_guide/platforms/legacy_sdks/ios/changelog/swift_changelog/changelog/swift_changelog/#3230' class='sdk-versions--chip ios-sdk' target='_blank'><i class='fa-brands fa-apple'></i> &nbsp; iOS: 3.23.0+ &nbsp;<i class='fa-solid fa-arrow-up-right-from-square'></i></a><a href='/docs/developer_guide/platforms/web/changelog/#250' class='sdk-versions--chip web-sdk' target='_blank'><i class='fa-solid fa-desktop'></i> &nbsp; Web: 2.5.0+ &nbsp;<i class='fa-solid fa-arrow-up-right-from-square'></i></a><a href='/docs/developer_guide/platforms/android/changelog/#800' class='sdk-versions--chip android-sdk' target='_blank'><i class='fa-brands fa-android'></i> &nbsp; Android: 8.0.0+ &nbsp;<i class='fa-solid fa-arrow-up-right-from-square'></i></a></div>
...
When creating an [in-app message](https://www.braze.com/docs/user_guide/channels/in_app_messages/traditional/), select **Simple Survey** for your **Message Type**.
...
![Compose tab of the simple survey editor, with fields for a header, optional body, and optional helper text.](https://www.braze.com/docs/assets/img/iam/iam-survey2.png?8e35d3a1382e45577656a97f2d700eff){: style="max-width:90%"}
...
![Choices dropdown with "Log attributes upon submission" selected.](https://www.braze.com/docs/assets/img/iam/collect-attributes.png?921d65e5342fe87a5781b8273c03492b){: style="max-width:60%"}
...
To add a custom attribute to each choice, select a custom attribute name from the dropdown menu (or create a new one), and then enter the value to set when this choice is submitted. You can also create a new custom attribute in your [Settings Page](https://www.braze.com/docs/user_guide/data/activation/custom_data/managing_custom_data/).
...
For example, in a [notification preferences survey](#notification-preferences), you might make each choice a boolean (true/false) attribute to allow users to select which topics they're interested in. If a user checks the "Promotions" choice, that will update their [user profile](https://www.braze.com/docs/user_guide/data/unification/user_data/user_profile_lifecycle/) with the custom attribute `Promotions Topic` set to `true`. If they leave the choice unchecked, that same attribute will remain unchanged.
...
![On-click behavior set to "Submit responses and display confirmation page".](https://www.braze.com/docs/assets/img/iam/confirmation-option.png?9a728fcaa75571c496fd5826b6ede848){: style="max-width:60%"}

If you elect to add a confirmation page, switch to the **Confirmation Page** tab to customize your message:

![Confirmation Page tab of the simple survey editor. The available fields are header, optional body, button text, and button on-click behavior.](https://www.braze.com/docs/assets/img/iam/confirmation-page.png?9ed1a106a47f50a968601ae839b5a01b){: style="max-width:90%"}
...
![Compose tab of the simple survey editor with the Color Theme picker expanded after a user has clicked on the color palette.](https://www.braze.com/docs/assets/img/iam/color-theme-picker.png?811911323d5a6b7ec810d44fc0ab5783){: style="max-width:80%"}
...
For definitions of survey metrics, refer to the [Report Metrics Glossary](https://www.braze.com/docs/user_guide/analytics/metrics_glossary/) and filter by "In-App Message".

Check out [In-app message reporting](https://www.braze.com/docs/user_guide/channels/in_app_messages/reporting/) for a breakdown of your campaign metrics.
