...
![A Facebook ad from Calorie Rocket that advertises free delivery, and the respective WhatsApp conversation that occurs when a user selects the ad's button.](https://www.braze.com/docs/assets/img/whatsapp/ads_that_click_whatsapp.png?e13f47751a3316da63ebbea4d404620d){: style="max-width:70%;"}
...
![Ads Manager with a composer to create an engagement ad.](https://www.braze.com/docs/assets/img/whatsapp/meta_ads_composer.png?113b11545750e3b482691555ad337f5c)
...
![Ads Manager template composer with a pre-filled message of "I want free delivery".](https://www.braze.com/docs/assets/img/whatsapp/pre_filled_message.png?19506f057ebc8633dce5817273b66828)
...
![Entry schedule for an action-based Braze Canvas, with the trigger event of "Send a WhatsApp inbound message" and a message body that matches regex of "free delivery".](https://www.braze.com/docs/assets/img/whatsapp/action_based_free_delivery.png?aa258e12ec373479bf20fdcb8d8dc990)
...
![WhatsApp message composer with button replies of "Yes" and "No Thanks".](https://www.braze.com/docs/assets/img/whatsapp/quick_replies.png?2ee5859006c72805111ef1108c6b3379)

![Canvas step with an "Opting in" group with a trigger event of "Sent inbound WhatsApp to subscription group" and a trigger word of "YES".](https://www.braze.com/docs/assets/img/whatsapp/opting_in_step.png?ddde7743adb2268164cc306319e3d415)
