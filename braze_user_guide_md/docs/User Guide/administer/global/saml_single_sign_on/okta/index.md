...
![Okta SAML SSO enabled on the Security Settings page.](https://www.braze.com/docs/assets/img/Okta/okta1.png?53d4dd7031d20f796136684ae3ce9299)
...
![](https://www.braze.com/docs/assets/img/Okta/okta5.png?c6e5d80403fe478535856bb1723f18c0){: style="max-width:75%"}
...
![Okta Default RelayState in the Sign On tab.](https://www.braze.com/docs/assets/img/Okta/okta2.png?1e509eff50ff8ab6a250d96b7796482e){: style="max-width:75%"}
...
![Braze dashboard login with Okta SSO enabled.](https://www.braze.com/docs/assets/img/Okta/okta4.png?eed5bd7f5f0d0547a84575558a838f40){: style="max-width:60%"}
