...
![Transformation details with the option to choose "Use a template" or "Start from scratch" for your editing experience.](https://www.braze.com/docs/assets/img/data_transformation/data_transformation10.png?69206c0170cb582c0ca564928007c6c9){: style="max-width:80%;"}
...
![Example Data Transformation code that maps the webhook to Braze user profiles.](https://www.braze.com/docs/assets/img/data_transformation/data_transformation11.png?6c5d5b2bc70dc2fd02f05bb5f960e9b5)
...
4. Select **Validate** to return a preview of your code’s output and to check if it is an acceptable request for the [Update multiple catalog items endpoint](https://www.braze.com/docs/api/endpoints/catalogs/catalog_items/asynchronous/put_update_catalog_items).<br><br>
