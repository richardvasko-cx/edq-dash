...
![The "Email Variants" section with an example email body.](https://www.braze.com/docs/assets/img/dnd/dnd_emailvariant.png?12f6f1334c55a61f7ce07638e9f19b68)
...
![Auto width option in the Content tab of the drag-and-drop editor.](https://www.braze.com/docs/assets/img/dnd/dnd1.png?ccbed4576dc02aa891cef9941f1314a2)
...
![Example of the color layering in the drag-and-drop editor.](https://www.braze.com/docs/assets/img/dnd/dnd2.png?96f00a669f9c37196300b72996e7911a)

### Content padding

![Block Options for the drag-and-drop editor.](https://www.braze.com/docs/assets/img/dnd/dnd3.png?6b0cdbe0288d097c936a55e1eebc46b9){: style="float:right;max-width:25%;margin-left:15px;"}
...
![Setting the "Language" value for an email.](https://www.braze.com/docs/assets/img/dnd/language_setting_dnd.png?2d95763a06f38f9a544661a525f8dd66){: style="max-width:70%;"}

### Personalization

![Options for adding personalization for the drag-and-drop editor.](https://www.braze.com/docs/assets/img/dnd/dnd4.png?79a6ecf0ffb95b0465a3efa093e99b34){: style="float:right;max-width:25%;margin-left:15px;"}
...
![The "Attributes" section with the attribute "clicktracking" turned off for a link.](https://www.braze.com/docs/assets/img/dnd_custom_attributes.png?24accef8abcaa72e08fbacb306423dbc){: style="float:right;max-width:35%;margin-left:15px;"}
