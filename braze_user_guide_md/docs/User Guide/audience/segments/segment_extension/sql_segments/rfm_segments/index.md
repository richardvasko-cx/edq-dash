...
![Modal with the option to create a catalog segment for events, purchases, or RFM segments.](https://www.braze.com/docs/assets/img/segment/select_rfm_segment.png?6f26ff905a1ac2134ba9e8d2b5b4bf3f){: style="max-width:80%" }
...
![Variables panel with the "Champions" and "Loyal Users" RFM groups selected.](https://www.braze.com/docs/assets/img/segment/rfm_groups.png?9d99fed5384badd1d9557d8a3447fdc0)
