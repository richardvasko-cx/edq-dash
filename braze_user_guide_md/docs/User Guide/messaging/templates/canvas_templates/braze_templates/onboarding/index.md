...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/onboarding_old_name_description.png?2f560e4879656bf343a32a0633e2a62a){: style="max-width:60%;"}
...
![The new name, description, and tag for the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/onboarding_new_name_description.png?c6e69d65acb4e09f1076d33351f91a37){: style="max-width:60%;"}
...
![Primary Conversion Event - A with the conversion type "Performs Custom Event" with the custom event name "Email Click". There is a 4-day conversion deadline.](https://www.braze.com/docs/assets/img/canvas_templates/onboarding1.png?171f9617ba42dbee9906c7a858549977)
...
![An entry window with the start time October 28, 2024 at 8 am. Users will enter this message in their local time zone.](https://www.braze.com/docs/assets/img/canvas_templates/onboarding4.png?4587a5f35f5f837c8b2ab505b8ad6b6d)
...
![An Audience Split step with one path for engaged users and one path for everyone else.](https://www.braze.com/docs/assets/img/canvas_templates/onboarding2.png?9c100e8c4a0cc1d9eebbe4faf79420e2){: style="max-width:70%;"}
