...
Note that in cases where your segment is very small relative to your workspace size, it's possible for the User Preview to return zero users. This doesn't necessarily mean that there are zero users in your segment; run [Calculate Exact Stats](https://www.braze.com/docs/user_guide/audience/segments/measuring_segment_size#statistics-for-segment-size) to determine your segment's exact size.

![User Preview](https://www.braze.com/docs/assets/img_archive/user_preview.png?c53ebba4137662641fed6a57537143f8)
