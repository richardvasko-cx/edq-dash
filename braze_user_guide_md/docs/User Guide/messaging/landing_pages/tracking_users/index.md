...
![An example page URL for a landing page in Braze.](https://www.braze.com/docs/assets/img/landing_pages/url-handle-example.png?3d237978c302edadb944e7904bca1d7e){: style="max-width:80%;"}
...
![The 'Add personalization' button in the drag-and-drop editor.](https://www.braze.com/docs/assets/img/landing_pages/select-personalization.png?687ef47612c64974d0402d6fe62d7512){: style="max-width:75%;"}
...
![An auto-generated Liquid tag for the selected landing page.](https://www.braze.com/docs/assets/img/landing_pages/get-snippet.png?73c523b0a304bb01f84d81d80c512a5b){: style="max-width:40%;"}
