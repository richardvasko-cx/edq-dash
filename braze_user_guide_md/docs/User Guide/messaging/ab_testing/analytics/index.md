...
> This article explains how to view the results of a multivariate or A/B test. If you haven't set up your test yet, refer to [Create multivariate and A/B tests](https://www.braze.com/docs/user_guide/messaging/ab_testing/create_tests/) for steps.
...
Your analytics view will vary depending on if you selected an [optimization](https://www.braze.com/docs/user_guide/messaging/ab_testing/optimizations/) during your initial setup.
...
![Performance section of the Campaign Analytics for an email campaign with multiple variants. The table lists various performance metrics for each variant, such as recipients, bounces, clicks, and conversions.](https://www.braze.com/docs/assets/img_archive/ab_analytics_no_optimization.png?0fa2428659dd160edac759479ba1025f)

For more details, refer to the [Campaign Analytics](https://www.braze.com/docs/user_guide/analytics/reports/campaign_analytics/) article for your messaging channel.
...
If one variant outperformed all the others with better than 95% [confidence](https://www.braze.com/docs/user_guide/messaging/ab_testing/analytics/#understanding-confidence), Braze marks that variant with a "Winner" label.
...
![Results of an initial test sent to determine the Winning Variant where no variant performed better than the others with enough confidence to meet the 95 percent confidence threshold for statistical significance.](https://www.braze.com/docs/assets/img_archive/ab_analytics_wv_insufficient_confidence.png?c4e4b9fbb8ea4181090db6bc7dcf7214)
...
![Results of the Winning Variant sent to the Winning Variant group.](https://www.braze.com/docs/assets/img_archive/ab_analytics_wv_1.png?4da491d76370efd8ac7a75f45d5512a5)
...
![Results of an initial test sent to determine the best performing variant for each user. A table shows the performance of each variant based on various metrics for the target channel.](https://www.braze.com/docs/assets/img_archive/ab_analytics_pv_initial_test_1.png?99f2ee617e5c2315e5a95e915bf11eaf)
...
![](https://www.braze.com/docs/assets/img_archive/ab_analytics_pv_3.png?495cdd10a3adb9038f716431eb3ccee7)
...
![The User Characteristics table, which shows which users are predicted to prefer Variant A and Variant B based on the three buckets they fall in for recency, frequency, and tenure.](https://www.braze.com/docs/assets/img_archive/ab_analytics_pv_initial_test_2.png?2d3c5d7d0bf6e021264fdf217f68c294)
...
![Personalized Variant tab for a campaign optimized for unique opens. The cards show the Projected Lift, Overall Unique Opens (with Personalized Variant), and Projected Unique Opens (with Winning Variant).](https://www.braze.com/docs/assets/img_archive/ab_analytics_pv_1.png?14def63c16cde18c061da7e05f81a79a)
...
![](https://www.braze.com/docs/assets/img_archive/ab_analytics_pv_2.png?468783130bf7839e4650056bc9cc28a7)
...
If you're A/B testing re-engagement messages, don't forget to compare the long-term impact of different variants using [Retention Reports](https://www.braze.com/docs/user_guide/analytics/reports/retention_reports/). You can use Retention Reports to analyze how each variant impacted any user behavior of your choice days, weeks, a month after message receipt, and see if there is uplift.
