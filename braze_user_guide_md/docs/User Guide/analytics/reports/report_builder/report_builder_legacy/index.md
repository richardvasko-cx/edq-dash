...
![Campaign dashboard](https://www.braze.com/docs/assets/img/campaign_comparison/create_report.png?6a1a878865e43fe100ce7796bb7a4f2b){: style="max-width:80%;"}
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Step 1: Create a new report" }
...
![Campaign numerical metric](https://www.braze.com/docs/assets/img/campaign_comparison/metric.png?c508261d4bf4a32c03f4b8bf9603b81a){: style="max-width:60%;"}
...
![Campaign Note](https://www.braze.com/docs/assets/img/campaign_comparison/comparison_name.png?8400b573166da39ed03b0b5908cbd22e){: style="max-width:60%;"}
...
![Campaign Note](https://www.braze.com/docs/assets/img/campaign_comparison/compare_note.png?195726d703f861ea09d029f9fe30e49d){: style="float:right;max-width:15%;margin-left:15px;"}
...
![Variants](https://www.braze.com/docs/assets/img/campaign_comparison/campaign_comparison1.png?129baf0e46dc0057026ac74719780dcc){: style="max-width:90%;"}
...
![Steps](https://www.braze.com/docs/assets/img/campaign_comparison/campaign_comparison2.png?a7ec510d89d2bb2dc19557e8039982e3){: style="max-width:90%;"}
...
![Report](https://www.braze.com/docs/assets/img/campaign_comparison/campaign_comparison3.png?a24af54a74bc8ec8395cbffa60aad9a4){: style="max-width:90%;"}
...
![Campaign Download](https://www.braze.com/docs/assets/img/campaign_comparison/download.png?e93c942dcf59786e99c402d641b371dd){: style="max-width:60%;"}
...
![Campaign Performance chart with metric Message Sent selected](https://www.braze.com/docs/assets/img/campaign_comparison/report_builder_charts.png?fcc3432e2857ccd986aad9dd34ea7d56)
