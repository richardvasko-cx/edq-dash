...
> Learn how to put custom agents to use in Canvas steps or catalog fields after you create them. For an introduction, see [Braze Agents](https://www.braze.com/docs/user_guide/brazeai/agents/).

## Agents in Canvas  

You can use agents as steps in a journey to personalize messages or guide decisioning in real time. For detailed setup steps, refer to [Agent step](https://www.braze.com/docs/user_guide/messaging/canvas/canvas_components/agent_step/).
...
![An Agent step in a catalog field.](https://www.braze.com/docs/assets/img/ai_agent/agent_in_catalog.png?5d4dbf80c113b5f7998f3417830fe990){: style="float:right;max-width:30%;margin-left:15px;"}
...
![The option to select "Apply AI agent" for a catalog field.](https://www.braze.com/docs/assets/img/ai_agent/edit_agent_column.png?83fa691af7497951ff192ee8a04c6ac6){: style="max-width:80%;"}
