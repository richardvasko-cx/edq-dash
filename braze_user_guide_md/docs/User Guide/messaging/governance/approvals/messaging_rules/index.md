...
![The "Summary" step of the Canvas workflow that shows you need an approval to launch.](https://www.braze.com/docs/assets/img/non_approver_banner.png?26e940dbdd5103df9599ea4eecbf2d5a){: style="max-width:90%;"}
