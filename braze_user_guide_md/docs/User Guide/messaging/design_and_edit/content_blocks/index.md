...
5. Copy and paste the Liquid snippet into a text editor block. <br>![The Add Personalization tab with options.](https://www.braze.com/docs/assets/img_archive/dnd_content_block_personalization.png?ee7ffe262a7dc0ce636e0de65424bddd){: style="max-width:30%;"}
...
![A preview of a Content Block "Workout_Promo" for cycling and dancing that has one inclusion.](https://www.braze.com/docs/assets/img/preview_tab_content_block.png?1ef25efcf86bcd4d9704e80d7c1be935){: style="max-width:60%;"} 
...
![A Content Block that reads "Welcome to our newsletter".](https://www.braze.com/docs/assets/img/copy-content-block.png?e8fcd5b10dd32d2fcca20385f3bfaae1)
...
![Expanded Settings dropdown menu that shows three options: Archive, Duplicate, and Copy to workspace.](https://www.braze.com/docs/assets/img/template_archive_cog.png?51b0a55f5dba6c7dd81b27e2590ec453){: style="max-width:20%;float:right;margin-left:15px;" }
...
![Saved Content Blocks panel where the settings dropdown menu for "Test_32" is expanded to show three options: Unarchive, Duplicate, and Copy to workspace](https://www.braze.com/docs/assets/img/unarchive-content-block.png?3fee5dd3783a4183d9b5c44d0b12bdbc)
