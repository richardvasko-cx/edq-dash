...
- **Default Workspace:** Select the workspace where new users should be added by default. If you don’t specify a workspace in your [SCIM API request](https://www.braze.com/docs/post_create_user_account/), Braze assigns users to this workspace.
...
![SCIM Provisioning settings form with three fields: Default Workspace, Service Origin, and optional IP Allowlisting. The “Generate SCIM Token” button is disabled.](https://www.braze.com/docs/assets/img/scim_unfilled.png?6f92e46ab53fde1b225fe35b659b037d)
...
![SCIM API Endpoint and SCIM Token fields displayed with masked values and copy buttons. Below the token field is a “Reset Token” button.](https://www.braze.com/docs/assets/img/scim.png?d45e0a5dc87a9436dbd387e110cd2c1b)
