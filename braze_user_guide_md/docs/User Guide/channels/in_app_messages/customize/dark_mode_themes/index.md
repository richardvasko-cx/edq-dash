...
Dark Mode, located in the **Design** tab when [creating an in-app message](https://www.braze.com/docs/user_guide/channels/in_app_messages/traditional/), lets you add an alternate color theme for users who are in Dark Mode on their device.
