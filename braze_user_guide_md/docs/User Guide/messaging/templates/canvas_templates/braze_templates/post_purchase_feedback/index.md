...
- A [custom attribute](https://www.braze.com/docs/user_guide/data/activation/attributes/custom_attributes#managing-custom-attributes) to reference for feedback survey results.
...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/post_purchase_feedback/select_edit_details.png?a38a38db93ea801d10bf805caf919254){: style="max-width:50%;"}
...
![The new name and description for the Canvas. The new description states: 'A post-purchase feedback Canvas to gauge interest for the upcoming expansion for PWD3, Liquid Mirage.'](https://www.braze.com/docs/assets/img/canvas_templates/post_purchase_feedback/enter_new_canvas_name.png?2fc28a5c8e4ae6cd5f970555be211704){: style="max-width:50%;"}
...
!["Assign Conversion Events" section for the conversion event type of purchasing Proxy War game product.](https://www.braze.com/docs/assets/img/canvas_templates/post_purchase_feedback/select_conversion_event.png?1e0e253f0042aad05af785a44a26fb50){: style="max-width:90%;"}
...
![A segment named "Purchased Proxy War 3" that segments users who have purchased the game.](https://www.braze.com/docs/assets/img/canvas_templates/post_purchase_feedback/entry_window_segment.png?c9145752543058ee90f2eea808cbc1e0){: style="max-width:90%;"}
...
!["Send Settings" step targeting users who are subscribed or opted in. Quiet Hours are turned on.](https://www.braze.com/docs/assets/img/canvas_templates/post_purchase_feedback/send_settings_with_quiet_hours.png?d669450be44cc3c9f436fda415472132){: style="max-width:90%;"}
...
![A webhook that creates support cases for customers who have a negative sentiment and want a refund for their purchase of Proxy War 3.](https://www.braze.com/docs/assets/img/canvas_templates/post_purchase_feedback/webhook_example.png?a98de8229e28c2b83f3949b8a2c4d32f){: style="max-width:90%;"}
