...
To learn how to add tags to campaigns, Canvases, segments, and custom data, see [Tags](https://www.braze.com/docs/user_guide/messaging/governance/tags/).
...
![The Tag Management page showing a list of tags organized by nested groups.](https://www.braze.com/docs/assets/img_archive/tags_view.png?945f0479dbc9031a408ebda7e4104f6d)
...
![The new tag dialog with the Nest Tag Under option selected.](https://www.braze.com/docs/assets/img_archive/tag_nested.png?6db0b2c61c5bc8c365ea327f23dfbc37){: style="max-width:70%;" }
...
Set up an Engagement Report to keep an eye on the volume of all campaigns with a certain tag. For example, if you want to monitor all of your push campaigns, you could add a tag like `Push Reporting` to those campaigns, then set up an [Engagement Report](https://www.braze.com/docs/user_guide/analytics/reports/engagement_reports#automatically-select-campaigns-or-canvases) to send you a report of those tagged campaigns every day.
