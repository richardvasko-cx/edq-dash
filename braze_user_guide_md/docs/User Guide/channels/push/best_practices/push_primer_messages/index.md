...
![Push primer in-app message for streaming app. The notification reads "Get push notifications from Movie Cannon? Notifications may include new movies, TV shows, or other notices and can be turned off at any time."](https://www.braze.com/docs/assets/img_archive/push_primer_iam.png?e0da29cb550d8e66ce3358dbb71d9b8c){: style="float:right;max-width:40%;margin-left:15px;border:none;"}
...
![In-app message composer with two buttons: "Allow notifications" and "Not now".](https://www.braze.com/docs/assets/img_archive/push_primer_button_behavior.png?aaff804b12d8dfc215d8b1514619c756)
...
![Action-based delivery settings to send to users who performed the custom event of "Add to Watch List".](https://www.braze.com/docs/assets/img_archive/push_primer_trigger.png?0cfda1c4aad7a95d0c6d3d3419fe4917)
