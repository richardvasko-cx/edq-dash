...
![Meta "Catalogs" page with an arrow pointing at the "Assign partner" button for the catalog called "sweeney_catalog".](https://www.braze.com/docs/assets/img/whatsapp/meta_catalog.png?86dce78e85128930d64ccd9a7835a83c){: style="max-width:90%;"}

Make sure to use the Braze Business Manager ID, `332231937299182`, as the partner business ID.

![Window to share a catalog with a partner that contains fields to enter a partner business ID and assign the permission "Manage catalog".](https://www.braze.com/docs/assets/img/whatsapp/share_meta_catalog.png?e0bf752f4f3e37f7c3102635b8ed687c){: style="max-width:70%;"}

{: start="3"}
3. Select your Meta catalog settings. You must select **Show catalog icon in chat header** to send catalog messages.

![WhatsApp Manager settings page for the "Catalog_products" catalog.](https://www.braze.com/docs/assets/img/whatsapp/meta_catalog_settings.png?6fece868f2cde990b8a6a88d6aed27a8){: style="max-width:90%;"}

{: start="4"}
4. In Braze, go through the [embedded signup](https://www.braze.com/docs/user_guide/channels/whatsapp/whatsapp_setup/embedded_signup/) process to provide permissions. Be sure to select **all** the catalogs you want to provide permissions for. This will unlock the Braze integrated product selector.

![Window with five catalogs selected provide permissions.](https://www.braze.com/docs/assets/img/whatsapp/select_catalogs.png?7ddceedf4daf5eb5823a474271f05411){: style="max-width:50%;"}
...
![Item list with fields to enter your section titles and content ID.](https://www.braze.com/docs/assets/img/whatsapp/multi_product_template.png?0ad51f71ee7d0b03abd39de2e94d8692){: style="max-width:60%;"}

![Item list with dropdown of items to select from.](https://www.braze.com/docs/assets/img/whatsapp/content_id_items.png?b466a34d4e542d8a7cc8174efbd6c1f2){: style="max-width:60%;"}
...
![Options to select a message type and response message layout, with "Response Message" and "Meta Product Messages" highlighted.](https://www.braze.com/docs/assets/img/whatsapp/response_message_layouts.png?4aa3ffcb9f18625c890153cd59e3fcaa){: style="max-width:90%;"}

{: start="5"}
5. Select the [message type](#product-message-types) you'd like to use.

![Message layout selection of "Multi-product".](https://www.braze.com/docs/assets/img/whatsapp/multi-product_message_layout.png?7f2c17706c1b1ae4019e60126184c78a){: style="max-width:90%;"}

{: start="6"}
6. Continue building your message.

![Example Meta product message with filled out information for products.](https://www.braze.com/docs/assets/img/whatsapp/example_response_message.png?6ca629591b0cf95845ac125d275dfcc3){: style="max-width:90%;"}
...
!["Add Personalization" window with a personalization type of "WhatsApp Properties" and a highlighted attribute of "inbound_product_id".](https://www.braze.com/docs/assets/img/whatsapp/inbound_product_questions.png?21540b1e10736dd71f4aea73bb30548c){: style="max-width:60%;"}
...
You can find additional Braze cart event information in [Types of eCommerce recommended events](https://www.braze.com/docs/user_guide/data/activation/events/recommended_events/ecommerce_events#types-of-ecommerce-recommended-events).
...
![Canvas step for an `ecommerce.cart_updated` custom event trigger with the basic property of "source" equaling `whats_app`.](https://www.braze.com/docs/assets/img/whatsapp/product_message_canvas_step.png?9b37f2f8f467ff5b80dcb6b11a59f49b)
...
![Diagram showing the checkout experience workflow for a Liquid-generated cart: Meta sends an order received message to Braze, which triggers an action-based trigger then creates a message with a cart link, which then sends a WhatsApp message.](https://www.braze.com/docs/assets/img/whatsapp/liquid_generated_cart_link_checkout.png?d160750ec426896f3debecc2b663ed98)
...
1. Create a webhook campaign or Canvas step triggered by the [`ecommerce.cart_update`](https://www.braze.com/docs/user_guide/data/activation/events/recommended_events/ecommerce_events?tab=ecommerce.cart_updated) eCommerce event, which will send the cart data to your eCommerce system.
2. Create a WhatsApp campaign or Canvas Message step triggered by the same eCommerce event to send a WhatsApp response message with the cart URL to the user. Follow the direction in the subsequent response message to use [Connected Content](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/).

![Diagram showing the checkout experience workflow for a Connected Content call: Meta sends an order received message to Braze, which has back-and-forth calls with an eCommerce platform, then sends a WhatsApp message.](https://www.braze.com/docs/assets/img/whatsapp/connected_content_checkout.png?3b5cc6eee0da220db6b74f7248cbe156)
...
![Diagram showing the checkout experience workflow for webhooks and custom events: Meta sends an order received message to Braze, which has back-and-forth calls with an eCommerce platform, then sends a WhatsApp message with the cart URL.](https://www.braze.com/docs/assets/img/whatsapp/webhooks_custom_events_checkout.png?fd88b7b5283e4c4cff6d1e54b7726fdf)
