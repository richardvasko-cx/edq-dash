...
For the sake of saving you time and ensuring a smooth integration, we recommend you and your Engineering team set up your custom events, custom attributes, and the SDK at the same time. Learn more about the steps that your Marketing and Engineering teams will need to think through together by reading our [implementation article](https://www.braze.com/docs/user_guide/get_started/integrations/). 

## Data aggregation

The Braze SDK automatically captures user-level data, giving you key metrics for your app and user base. Group similar apps into a single workspace (for example, iOS and Android versions together) to view collected data across platforms and build a complete picture of user activity. See the article on the [Home page](https://www.braze.com/docs/user_guide/analytics/dashboards/home/) for more information.

## In-app messaging

Use the SDK to compose and send in-app messages directly. You can choose slideup, modal, or fullscreen messages based on your campaign strategy. For composition details, refer to [Create an in-app message](https://www.braze.com/docs/user_guide/channels/in_app_messages/traditional/).

![Push displayed on a web browser](https://www.braze.com/docs/assets/img_archive/web_push_macbook.png?eac968adb54a2b21e85adbab8933882d){: style="float:right;max-width:45%;margin-left:20px;border:0;"}

## Push notifications

Push notifications are another great option to engage with your users and are especially useful to handle time-sensitive calls to action. Mobile push notifications appear on your users' devices, and web push notifications appear even when your site is not open. For specifics on using push notifications, see our [push notification article](https://www.braze.com/docs/user_guide/channels/push/).

Users of your website or app need to opt-in to receive push notifications. See [push priming](https://www.braze.com/docs/user_guide/channels/push/best_practices/push_primer_messages/) for more details. 
...
![Segment Details page with web app in focus](https://www.braze.com/docs/assets/img_archive/web-users-segment.png?025b10bb40f87ba3173337b6844a13cd){:style="max-width:60%"}
...
Braze provides SDKs for multiple platforms, like Web, Android, and Swift. For the complete list, see the [Braze Developer Guide](https://www.braze.com/docs/developer_guide/home).
