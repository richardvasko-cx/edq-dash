...
![Settings page for the Upon Voyage iOS app with fields for the API Key and SDK Endpoint.](https://www.braze.com/docs/assets/img/workspaces/app_api_key.png?3cf777502ab106f13058cf836accd07f)
...
!["Live SDK Version" section with a field value of "5.4.0" and an icon that says a new version is available.](https://www.braze.com/docs/assets/img/workspaces/app_live_sdk_version.png?8102d13d372f80477f96a0ceeb935776)
...
![The App Settings page with a button to delete a workspace and a trash can icon to delete an app.](https://www.braze.com/docs/assets/img/workspaces/workspace_delete.png?6a4990078154bee1d8f79ffc2be4b133)
...
If you're updating your app, you should separate the old and new versions by creating a new app instance within the same workspace. This way, you can effectively target users on the new version when you select that app during segmentation. If you want to message users who are on the old version, you can use filters to [target the previous app version](https://www.braze.com/docs/user_guide/messaging/campaigns/ideas_and_strategies/new_features#filtering-by-most-recent-app-versions).
...
![Segment that is targeting users from specific apps.](https://www.braze.com/docs/assets/img/workspaces/users_from_specific_apps_filter.png?f48b63f3e5fc9fc27df269b2a7377585)
...
**Expand for steps in the original Canvas workflow**
