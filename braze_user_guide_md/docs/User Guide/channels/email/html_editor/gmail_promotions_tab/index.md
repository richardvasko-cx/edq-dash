...
![Options to specify the offer value, code, and start date and time for a discount offer.](https://www.braze.com/docs/assets/img/gmail_promo_discount_details.png?fd574c849be74e78430932c53e0d2775){: style="max-width:70%;"}
...
![Options to specify the offer value, code, and start date and time for a Deal Card.](https://www.braze.com/docs/assets/img/gmail_promo_deal_cards.png?a4147bcd8ee227b029e40903dc72c540){: style="max-width:70%;"}
