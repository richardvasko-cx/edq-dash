...
![The current title and description of the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/feature_adoption/select_edit_details.png?88337940107e6da9de24b48f923f238e){: style="max-width:60%;"}
...
![The new name and description for the Canvas. The new description states: 'A feature adoption Canvas to track adoption and user sentiment for Cruise Control, a feature for scheduling recurring food deliveries.'](https://www.braze.com/docs/assets/img/canvas_templates/feature_adoption/enter_new_canvas_name.png?4c4670c5a160ccf4239c11713598d652){: style="max-width:60%;"}
...
![The conversion event window in the Canvas.](https://www.braze.com/docs/assets/img/canvas_templates/feature_adoption/assign_conversion_event_cruise_control.png?8ee52c29c6ca5c21e9bee25148aa5b5f){: style="max-width:90%;"}
...
![The segment for all users who have not used Cruise Control.](https://www.braze.com/docs/assets/img/canvas_templates/feature_adoption/cruise_control_segment.png?15845dd1e19f28e7edb0442ad0bf4ad2){: style="max-width:90%;"}
...
![The action group name set to "Added to cart" and the "Perform Custom Event" set to "added_to_cart".](https://www.braze.com/docs/assets/img/canvas_templates/feature_adoption/action_path_added_to_cart.png?4cd9771813af95a88d00a6ee577b3fc2){: style="max-width:60%;"}
