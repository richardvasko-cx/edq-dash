...
| Icon | Image |
| --- | --- |
| `RUNNING_HOME` | ![A running shoe icon.](https://www.braze.com/docs/assets/img/braze_pilot/running_home_icon.png?da115c4661380d3fd28b70c4f49f8a8e){:style="max-width:30%"} |
| `HEART_DETAILS` | ![A heart icon.](https://www.braze.com/docs/assets/img/braze_pilot/heart_details_icon.png?741b274c8c138ed0b501732bde725af7){:style="max-width:30%"} |
| `TIMER_DETAILS` | ![A stopwatch icon.](https://www.braze.com/docs/assets/img/braze_pilot/timer_details_icon.png?de857ddd16cf28b41542dc884b1e3c22){:style="max-width:30%"} |
| `YOGA_HOME` | ![An icon of person in a yoga pose.](https://www.braze.com/docs/assets/img/braze_pilot/yoga_home_icon.png?af6fb7f1b02a8bf7e75284471cb2e222){:style="max-width:30%"} |
| `BICYCLE_HOME` | ![A bicycle icon.](https://www.braze.com/docs/assets/img/braze_pilot/bicycle_home_icon.png?fc44c0a018630f453629c5059c2014f5){:style="max-width:30%"} |
| `DUMBBELL_HOME` | ![A dumbbell icon.](https://www.braze.com/docs/assets/img/braze_pilot/dumbbell_home_icon.png?e8091887614a8fde8aa08b4677cbe98f){:style="max-width:30%"} |
