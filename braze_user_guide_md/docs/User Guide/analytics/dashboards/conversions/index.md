...
2. Log an [attribution method](https://www.braze.com/docs/user_guide/analytics/dashboards/conversions#attribution-methods).
...
![Conversion details table showing Touches as the attribution method for columns three and four.](https://www.braze.com/docs/assets/img_archive/conversions2_details.png?3f94627f9210e60a7c774717c47be35e){: style="border:none"}
...
This bar graph shows the absolute counts for each [engagement event](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events/) based on the selected channel. The conversions count will be defined as per the selected attribution method.
...
![Conversions funnel bar graph for two email campaigns showing similar results for Email Delivered, Email Opened, Email Clicked, and Conversions.](https://www.braze.com/docs/assets/img_archive/conversions2_funnel.png?43392d9b37952f27044d6d2fc02c7366)
...
![Conversions over time time series graph for two email campaigns, showing conversions by day.](https://www.braze.com/docs/assets/img_archive/conversions2_over_time.png?1cb62ca458f54f4b7b25678eb6376c0e)
...
When a campaign triggers a session start or custom event, you want to ensure that this event, or session, is happening frequently enough to trigger the message. Check the [home dashboard](https://www.braze.com/docs/user_guide/analytics/dashboards/home/) for session data, or your [custom events](https://www.braze.com/docs/user_guide/analytics/reports/configure_reporting/) report.
...
Check that you've reviewed information on [conversion tracking rules](https://www.braze.com/docs/user_guide/messaging/messaging_fundamentals/conversion_events#conversion-tracking-rules) to understand your campaign metrics. For user conversions in Canvas, refer to [Canvas FAQ](https://www.braze.com/docs/user_guide/messaging/canvas/faqs#how-are-user-conversions-tracked-in-a-canvas). 