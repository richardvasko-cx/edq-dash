...
!["Outbound Email Settings" section with fields for different display names and domains.](https://www.braze.com/docs/assets/img/email_settings/display_name_address.png?40c5db46de4ed97a18c9fa5a1278825b)

#### Personalize with Liquid

You can also use [Liquid](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/liquid/) in the **From Display Name**, **Local Part**, and **Domain** fields to dynamically template the sender name and email address based on custom attributes. Note that to use Liquid in the **Domain** field, you must go to an email campaign's **Sending Info** options and select the **Customize from display name + address** checkbox.

![Sending settings with fields for customizing the from display name, address, and domain.](https://www.braze.com/docs/assets/img/email_settings/email_campaign_domain.png?be2533bf9ae540ad4c3a082d6653bcca)

For example, you can use conditional logic to send from different brands or regions:
...
!["Reply-To Address" section with fields to enter multiple reply-to addresses.](https://www.braze.com/docs/assets/img/email_settings/reply_to_address.png?4bd2fbf9de8420c55e83bceec0cbde25){: style="max-width:75%;" }

#### Personalize with Liquid

You can also use [Liquid](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/liquid/) in the **Reply-To Address** field to dynamically template the reply-to address based on custom attributes. For example, you can use conditional logic to send replies to different regions or departments:
...
BCC addresses are available for Amazon SES, SendGrid, and SparkPost. As an alternative to BCC addresses, we recommend using [messaging archiving](https://www.braze.com/docs/user_guide/data/distribution/export_braze_data/message_archiving/) to save a copy of messages sent to users for archival or compliance purposes.
...
For example, you can add `{{custom_attribute.${support_agent}}}` as the BCC address for emails from your support team.

![BCC Address section of the Email Settings tab with a BCC address using Liquid.](https://www.braze.com/docs/assets/img/email_settings/dynamic_bcc.png?74a985ae1cb566cbe5c71e83a943a7e0){: style="max-width:90%;" }
...
[![Braze Learning course](https://www.braze.com/docs/assets/img/bl_icon3.png?5f6465f63e399dec15d7020b6f4d2452)](https://learning.braze.com/email-open-tracking-pixel/){: style="float:right;width:120px;border:0;" class="noimgborder"}
...
!["Open Tracking Pixel" section with the options to move for SendGrid, SparkPost, or Amazon SES.](https://www.braze.com/docs/assets/img/open_pixel.png?c33c72019e4f05ecee9bf1848da71b1f){: style="max-width:80%;" }
...
![](https://www.braze.com/docs/assets/img_archive/list_unsub_img1.png?29f75f3af0dcf74113993afa4fb36d72){: style="float:right;max-width:60%;margin-left:15px;"}
...
![Selecting the "users who are subscribed or opted in" for which users to send to.](https://www.braze.com/docs/assets/img/email_settings/email_unsub_header_workspaces.png?32d241ac8f2639f4ba0add5d0bac55a4){: style="float:right;max-width:50%;margin-left:15px;"}
...
![Option to automatically include a list-unsubscribe header for emails sent to subscribed or opted-in users.](https://www.braze.com/docs/assets/img/email_settings/email_unsubscribe_header.png?c4e53973f1349338a7990a09ab7461c3)
...
![](https://www.braze.com/docs/assets/img/email_settings/one_click_list_unsubscribe_message_level.png?78491c83de430c3d39a395fac6637f12){: style="max-width:70%;"}
...
![](https://www.braze.com/docs/assets/img/email_settings/email_unsubscribe_header_custom.png?6f31f63ff7847cf75b2fa8acbed94a7a){: style="max-width:80%;"}
...
![](https://www.braze.com/docs/assets/img/email_settings/test_and_seed_email_subject_line.png?d3076d67bc3eb59877b3c1eff2159529){: style="max-width:70%;"}
...
Changing this setting does not affect any of your existing email messages or templates. You can override this default at any time while composing messages or templates. For more information, refer to [CSS inlining](https://www.braze.com/docs/user_guide/channels/email/html_editor/css_inline/).
...
![](https://www.braze.com/docs/assets/img/email_settings/resubscribe_users.png?866852bee82c1127d8a91ac42f5145f9){: style="max-width:90%;" }
...
![](https://www.braze.com/docs/assets/img/email_settings/custom_footer.png?d6ef8e3b9a94ef9fbc5422c15d44c640)

To learn more about custom footer Liquid templating, check out our documentation on [Custom footers](https://www.braze.com/docs/user_guide/channels/email/subscriptions#changing-email-subscriptions).
...
![](https://www.braze.com/docs/assets/img/email_settings/custom_unsubscribe.png?84484d87c3101bdd7d62628878db6caf)

Learn more about best practices for email list management in [Managing email subscriptions](https://www.braze.com/docs/user_guide/channels/email/faq#unsubscribed-email-addresses).
...
![](https://www.braze.com/docs/assets/img/email_settings/custom_opt_in.png?3b73dc55346060c4c5e3a2a64dffa74e)
...
**Do I need to edit past email campaigns and Canvases to apply the one-click unsubscribe setting after enabling it?**
...
**Why do subscription groups have to match across message variants to launch?**
...
**What happens if a subscription group is archived? Does this break the one-click unsubscribe on emails sent?**
